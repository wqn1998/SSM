                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加','./hetongAdd.jsp',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                 ...
                                 <c:forEach items="${list }" var="u">
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="ids"  value="${u.hid }"   lay-skin="primary"> 
                                    </td>
                                    <td>${u.hid }</td>
                                    <td>${u.title }</td>  
                                    <td class="td-manage"> 
                                      ...
                                      <a title="删除" onclick="member_del(this,'${u.hid}')" href="javascript:;">

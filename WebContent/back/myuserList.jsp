                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                           <form class="layui-form layui-col-space5"    >
                                <div class="layui-inline layui-show-xs-block">
                                    <input class="layui-input"  autocomplete="off" placeholder="请输入姓名" name="name"  >
                                </div> 
                                 <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" onclick="xadmin.open('添加用户','./myuserAdd.jsp',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                 ...
                                 <c:forEach items="${list }" var="u">
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="ids"  value="${u.uid }"   lay-skin="primary"> 
                                    </td>
                                    <td>${u.uid }</td>
                                    <td>${u.name }</td>
                                    <td>${u.sex }</td>
                                    ...
                                    <td class="td-manage"> 
                                      <a title="编辑"  onclick="xadmin.open('编辑','toupdateMyuser.do?uid=${u.uid}',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
                                        <a onclick="xadmin.open('修改密码','topwdMyuser.do?uid=${u.uid}',600,400)" title="修改密码" href="javascript:;">
                                        <i class="layui-icon">&#xe631;</i>
                                      </a>  

...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form"  id="myform"    action="updateBaike.do"   method="post">
                   <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_email" name="title"  value="${g.title }" required="" lay-verify="x" autocomplete="on" class="layui-input">
                             <input type="hidden" id="L_email" name="bid"  value="${g.bid }" required="" lay-verify="x" autocomplete="on" class="layui-input">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                         <textarea placeholder="请输入内容" id="desc" name="daan" class="layui-textarea">${g.daan }</textarea>  
                            </div>

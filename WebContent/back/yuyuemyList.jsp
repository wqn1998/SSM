                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                           <form class="layui-form layui-col-space5"    >
                                <div class="layui-inline layui-show-xs-block">
                                    <input class="layui-input"  autocomplete="off" placeholder="请输起始日期" name="createtime" id="createtime"  >
                                </div> 
                                 <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-header">
                            ...
                            <!-- <button class="layui-btn" onclick="xadmin.open('添加','./yuyueAdd.jsp',600,400)"><i class="layui-icon"></i>添加</button> -->
                        </div>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody> 
                                 <c:forEach items="${list }" var="u">
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="ids"  value="${u.yid }"   lay-skin="primary"> 
                                    </td>
                                    <td>${u.yid }</td>
                                    <td>${u.myuser.name }</td>
                                    ...
                                    <td>${u.receive }</td>
                                   <td> <fmt:formatDate value="${u.receivetime}" pattern="yyyy/MM/dd HH:mm:ss" /></td>
                                     <td>${u.status }</td>
                                    <td class="td-manage"> 
                                      <a title="回复"  onclick="xadmin.open('回复','toupdateYuyue.do?yid=${u.yid}',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
                                     <!--  <a onclick="xadmin.open('修改密码','member-password.html',600,400)" title="修改密码" href="javascript:;">
                                        <i class="layui-icon">&#xe631;</i>
                                      </a> -->
                                      <a title="删除" onclick="member_del(this,'${u.yid}')" href="javascript:;">
                                        <i class="layui-icon">&#xe640;</i>
                                      </a>
                                    </td>
                                  </tr> 

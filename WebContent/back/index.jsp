        ...
        <div class="container">
           ...
           <!--  <ul class="layui-nav left fast-add" lay-filter="">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    <a href="javascript:;">${dangqianyonghu.name }</a>
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                            <a onclick="xadmin.open('个人信息','toupdateMyuser.do?uid=${dangqianyonghu.uid}')">个人信息</a></dd>
                        <dd>
                            <a onclick="xadmin.open('更改密码','topwdMyuser.do?uid=${dangqianyonghu.uid}')">更改密码</a></dd>
                        <dd>
                            <a href="./logout.jsp">退出</a></dd>
                    </dl>
                </li>
                  ...
                  <c:if test="${dangqianyonghu.role=='管理员' }"   > 
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('用户列表','showMyuser.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户列表</cite></a>
                            </li>
                             <li>
                                <a onclick="xadmin.add_tab('百科列表','showBaike.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>百科列表</cite></a>
                            </li>
                            
                             <li>
                                <a onclick="xadmin.add_tab('合同列表','showHetong.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>合同列表</cite></a>
                            </li>
                             <li>
                                <a onclick="xadmin.add_tab('预约列表','showYuyue.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>预约列表</cite></a>
                            </li>
                            
                            <li>
                                <a onclick="xadmin.add_tab('房源列表','showFangyuan.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>房源列表</cite></a>
                            </li> 
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('统计页面','tongji.jsp')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>统计页面</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="房源查看">&#xe723;</i>
                            <cite>房源查看</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                           
                            <li>
                                <a onclick="xadmin.add_tab('我的房源列表','showmyFangyuan.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>我的房源列表</cite></a>
                            </li> 
                            <c:if test="${dangqianyonghu.role!='管理员' }">
                            <li>
                                <a onclick="xadmin.add_tab('预约列表','showMyYuyue.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>预约列表</cite></a>
                            </li>
                            </c:if>
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('评论列表','showPinglun.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>评论列表</cite></a>
                            </li>  

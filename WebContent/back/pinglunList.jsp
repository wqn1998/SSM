                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                           <form class="layui-form layui-col-space5"    >
                                <div class="layui-inline layui-show-xs-block">
                                    <input class="layui-input"  autocomplete="off" placeholder="请输入内容" name="content"  >
                                </div> 
                                 <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-header">
                           ...
                           <!--  <button class="layui-btn" onclick="xadmin.open('添加','./pinglunAdd.jsp',600,400)"><i class="layui-icon"></i>添加</button> -->
                        </div>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                 ...
                                 <c:forEach items="${list }" var="u">
                                  <tr>
                                    <td>
                                      <input type="checkbox" name="ids"  value="${u.pid }"   lay-skin="primary"> 
                                    </td>
                                    <td>${u.pid }</td>
                                    <td>${u.myuser.name }</td>
                                    <td>${u.fangyuan.title }</td>
                                     <td>${u.content }</td>
                                    <td> <fmt:formatDate value="${u.createtime}" pattern="yyyy/MM/dd HH:mm:ss" /></td>
                                   
                                   
                                    <td class="td-manage"> 
                                      <%-- <a title="编辑"  onclick="xadmin.open('编辑','toupdatePinglun.do?pid=${u.pid}',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a> --%>
                                      <a title="回复"  onclick="xadmin.open('回复','tohuifuPinglun.do?pid=${u.pid}',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
                                     
                                      <a title="删除" onclick="member_del(this,'${u.pid}')" href="javascript:;">
                                        <i class="layui-icon">&#xe640;</i>
                                      </a>
                                    </td>
                                  </tr> 

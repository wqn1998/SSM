...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form"  id="myform"    action="addPinglun.do"   method="post">
                   <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline"> 
                          <input type="text" id="L_email"  value="${g.content }" required="" lay-verify="x" autocomplete="on" class="layui-input">
                            </div> 
                    </div>
                     <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            <span class="x-red">*</span>您的回复</label>
                        <div class="layui-input-inline"> 
                          <input type="text" id="L_email" name="content"   required="" lay-verify="x" autocomplete="on" class="layui-input">
                            </div> 
                    </div>
                    <div class="layui-form-item">
